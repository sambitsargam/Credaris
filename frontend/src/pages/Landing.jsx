...
const PROGRAMS = [
  ...
  { id: 'credaris_lending_v8', name: 'Lending Protocol', icon: '🏦', url: 'https://testnet.explorer.provable.com/program/credaris_lending_v8.aleo' },
];
...
function ArchitectureSection() {
  const rows = [
    ...
    { label: 'Contracts', tags: ['credaris_income_v3', 'credaris_credit_v4', 'credaris_lending_v8'] },
