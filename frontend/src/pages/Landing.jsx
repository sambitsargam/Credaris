  ...
  return (
    <div className="hero-preview">
      <div className="preview-card">
        ...
        <a href="https://testnet.explorer.provable.com/program/core_credaris.aleo" target="_blank" rel="noopener noreferrer" className="preview-row" style={{ textDecoration: 'none' }}>
          <div className="preview-row-icon">🏦</div>
          <span className="preview-row-name">core_credaris.aleo</span>
  ...
  return (
    <section className="land-section" style={{ paddingTop: 0 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <a
          href="https://testnet.explorer.provable.com/program/core_credaris.aleo"
          target="_blank"
