...
│ Program                 │ Purpose                              │
├─────────────────────────┼──────────────────────────────────────┤
│ credaris_income_v1.aleo │ Income verification & attestation    │
...
Explorer Links:
• https://testnet.explorer.provable.com/program/credaris_income_v1.aleo
...
4. GENERATE PROOF
   → Calls credaris_income_v1.aleo/attest_income transition
...
Input sources:
• credaris_income_v1.aleo → verified_incomes mapping (total income)
...
└─────────────────────────┼─────────────────────────────────┘
          ...
          ▼               ▼               ▼
┌─────────────────┐ ┌──────────────┐ ┌────────────────┐
│credaris_income_v1│ │credaris_     │ │credaris_       │
...
→ Example: GET /v2/testnet/program/credaris_income_v1.aleo/mapping/verified_incomes/aleo1abc...
→ Returns: "5000000u64"
      ...
      <div className="docs-shell">
        <nav className="docs-sidebar">
          ...
          <div style={{ marginTop: 'auto', paddingTop: 24, borderTop: '1px solid var(--border-subtle)' }}>
            <a href="https://testnet.explorer.provable.com/program/credaris_income_v1.aleo" target="_blank" rel="noopener noreferrer" className="docs-sidebar-item">
              Income Contract ↗
            </a>
